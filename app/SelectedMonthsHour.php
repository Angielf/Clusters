...
class SelectedMonthsHour extends Model
{
    protected $table = 'selected_months_hours';

    protected $fillable = ['selected_schedule_id', 'month_1', 'estimated_1', 'real_1', 'status_1',
    ...
    public function sender() {
        return $this->belongsTo(User::class, 'school_selected_schedule_id', 'id');
    }
