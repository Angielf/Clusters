    ...
    <div class="row">
        <div class="col-sm-8 offset-sm-2">
            ...
            <p class="alert alert-info" role="alert">
                <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-exclamation-octagon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg> - школы с низкими показателями
            </p>
            <div>
                @if ($errors->any())
                ...
                <form method="post" action="/region-clusters" enctype="multipart/form-data">
                    ...
                    @foreach ($districts as $district)
                        <a class="btn btn-outline-dark btn-lg" data-toggle="collapse"
                           href="#collapse{{ $district->id }}" role="button"
