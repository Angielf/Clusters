...
@section('content')
@if (Auth::user() && Auth::user()->id == $selected_months_hour->selected_schedule->selected_program->school_id)
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_1 === 9)
                            <a href="/selected_months_hour/true1/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not1/{{ $selected_months_hour->id }}"
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_2 === 9)
                            <a href="/selected_months_hour/true2/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not2/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-danger btn">
                                <i class="far fa-check-square"></i> Отклонить
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_3 === 9)
                            <a href="/selected_months_hour/true3/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not3/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-danger btn">
                                <i class="far fa-check-square"></i> Отклонить
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_4 === 9)
                            <a href="/selected_months_hour/true4/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not4/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-danger btn">
                                <i class="far fa-check-square"></i> Отклонить
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_5 === 9)
                            <a href="/selected_months_hour/true5/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not5/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-danger btn">
                                <i class="far fa-check-square"></i> Отклонить
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_6 === 9)
                            <a href="/selected_months_hour/true6/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not6/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-danger btn">
                                <i class="far fa-check-square"></i> Отклонить
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_7 === 9)
                            <a href="/selected_months_hour/true7/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not7/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-danger btn">
                                <i class="far fa-check-square"></i> Отклонить
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_8 === 9)
                            <a href="/selected_months_hour/true8/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not8/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-danger btn">
                                <i class="far fa-check-square"></i> Отклонить
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_9 === 9)
                            <a href="/selected_months_hour/true9/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not9/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-danger btn">
                                <i class="far fa-check-square"></i> Отклонить
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_10 === 9)
                            <a href="/selected_months_hour/true10/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not10/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-danger btn">
                                <i class="far fa-check-square"></i> Отклонить
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_11 === 9)
                            <a href="/selected_months_hour/true11/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not11/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-danger btn">
                                <i class="far fa-check-square"></i> Отклонить
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($selected_months_hour->status_12 === 9)
                            <a href="/selected_months_hour/true12/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-info btn">
                                <i class="far fa-check-square"></i> Подтвердить
                            </a>
                            <a href="/selected_months_hour/not12/{{ $selected_months_hour->id }}"
                                class="btn btn-outline-danger btn">
                                <i class="far fa-check-square"></i> Отклонить
                            </a>
                            @endif
